...
<div class="sec r" id="tools">
  ...
  <div class="tools-grid">
    ...
    <div class="tool-card active-tool">
      <div class="tool-card-label"><span>Tool 06 · NGO &amp; Nonprofit Security</span><span class="tool-status-badge tsb-active">New</span></div>
      <div class="tool-card-name">OpenGuard</div>
      <div class="tool-card-desc">A free security scanner built for nonprofits and small teams with no dedicated security staff. Checks for exposed legacy admin panels, outdated CMS versions, exposed API keys in JavaScript, missing security headers, and subdomain takeover risk, then generates one plain-language HTML report with an overall risk rating.</div>
      <div class="tool-versions">
...
<div class="sec r" id="faq">
  ...
  <div class="faq-wrap">
    ...
    <div class="faq-item">
      <div class="faq-q">What does OpenGuard do?</div>
      <div class="faq-a"><div class="faq-a-inner">OpenGuard is a free security scanner built for nonprofits and small teams without dedicated security staff. It checks a domain for exposed legacy admin panels (like phpMyAdmin or cPanel), outdated CMS versions, exposed API keys in JavaScript, missing security headers, and subdomain takeover risk, then generates a single plain-language HTML report with an overall risk rating. It is currently version 3.1.</div></div>
    </div>
    <div class="faq-item">
